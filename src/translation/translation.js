...
const translations = {
  ...
  en: {
    ...
    enterOthername: "Enter Other Name",
  ...
  tr: {
    ...
    costCentreTransferHistory: "Maaş ve Transfer Bilgileri",
    ...
    pleaseselectatleastoneitemtodownload:
      "Lütfen indirmek için en az bir öğe seçin.",
    ...
    oncedeletedyouwillnotbeabletorecoverthisemployee:
      "Silindikten sonra bu çalışanı kurtaramayacaksınız!",
  ...
  ru: {
    ...
    basis: "Основа",
    manager: "Менеджер",
    snils: "СНИЛС Информация",
    noSnils: "Нет информации СНИЛС",
    edit: "Редактировать",
    payrollHistory: "История расчета заработной платы",
    ...
    enterOthername: "Введите другое имя",
    enterFirstname: "Введите свое имя",
    enterSurname: "Введите свою фамилию",
    enterNumber: "Введите личный номер",
    finance: "Финансы",
    ...
    selectsubject: "Выберите Субъект РФ",
    close: "Закрыть",
    ...
    salarytransferinfo: "Информация о зарплате и переводах"
  },
};
