...
const translations = {
  ...
  payroll: {
    ...
    ru: {
      ...
      success: "успех",
      payrolladdedanddetailssentsuccessfully:
        "Платежная ведомость добавлена, и данные успешно отправлены",
      failedtoaddpayrollandsenddetails:
        "Не удалось добавить платежную ведомость и отправить реквизиты",
      novalidpayrolldataavailabletosend:
        "Нет доступных для отправки действительных данных о заработной плате",
      ...
      proofyourpayrollhasbeendeleted:
        "Пуф! Ваша платежная ведомость была удалена!",
